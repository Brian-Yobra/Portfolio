      ...
      <div className="container footer-grid">
        ...
        <div className="footer-brand-section">
          <div className="nav-brand" style={{ marginBottom: 'var(--spacing-sm)' }}>
            <Link href="/" style={{ color: 'white' }}>
              <Image src="/favicon.svg" alt="Logo" className="nav-brand-logo" width={32} height={32} />
              <span>
                Brian{' '}
                <span className="highlight" style={{ color: 'var(--color-accent-primary)' }}>
                  Kihara
                </span>
              </span>
            </Link>
          ...
          <p className="footer-brand-text">
            A fullstack developer specializing in modern web technologies, building performant,
            state-of-the-art web experiences.
          </p>
        </div>
        ...
        <div className="footer-connect-section">
          ...
          <div
            ...
            style={{ marginTop: 'var(--spacing-md)', display: 'flex', gap: 'var(--spacing-sm)' }}
          >
            <a
